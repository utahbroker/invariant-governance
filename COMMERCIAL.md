...
Invariant Governance uses an open-core licensing model:

### Community Edition (This Repository)
- **License**: Apache 2.0
- **Includes**: Core governance kernel, execution gate, advisory telemetry,
  approval receipts, fluidity tokens, poison pill broadcast, retraction cascade
- **Use**: Free for any purpose, including commercial use
...
|---------|-----------|------------|
| Governance Kernel | Yes | Yes |
| Execution Gate | Yes | Yes |
| Advisory Telemetry | Yes | Yes |
| Approval Receipts | Yes | Yes |
| Fluidity Tokens | Yes | Yes |
| Poison Pill Broadcast | Yes | Yes |
| Multi-tenant isolation | - | Yes |
| Compliance audit trails (SOC2, HIPAA, FedRAMP) | - | Yes |
| Hardware HAL Gate integration | - | Yes |
| Real-time governance dashboard | - | Yes |
| SSO / SAML / OIDC integration | - | Yes |
| Priority support (SLA-backed) | - | Yes |
...
2. **Operations**: Real-time dashboards showing safety manifold proximity,
   entropy trends, and governance health
3. **Hardware**: Integration support for FPGA-based HAL Gates in
